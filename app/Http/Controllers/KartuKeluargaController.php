    ...
    public function extract(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($extension === 'pdf' || in_array($extension, ['png', 'jpg', 'jpeg'])) {
                ...
                $filePath = $file->move(public_path('uploads/kartu-keluarga'), $fileName);
                $path = asset('uploads/kartu-keluarga/' . $fileName);
                
                $api_key = env('NANO_API',null);
                $modelId = '25aefa91-6011-4319-be5c-a04f3fe9d4ae'; //KartuKeluarga
                ...
                return view('model.kartu-keluarga', ['path' => $path, 'data' => $data]);
