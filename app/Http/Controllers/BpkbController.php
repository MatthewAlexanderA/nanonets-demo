    ...
    public function extract(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($extension === 'pdf' || in_array($extension, ['png', 'jpg', 'jpeg'])) {
                ...
                $filePath = $file->move(public_path('uploads/bpkb'), $fileName);
                $path = asset('uploads/bpkb/' . $fileName);
                
                $api_key = env('NANO_API',null);
                $modelId = '92183991-c65b-4a32-9dad-cf4ee85a1fee'; //Bpkb
                ...
                return view('model.bpkb', ['path' => $path, 'data' => $data]);
