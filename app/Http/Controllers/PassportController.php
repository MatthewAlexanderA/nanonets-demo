    ...
    public function extract(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($extension === 'pdf' || in_array($extension, ['png', 'jpg', 'jpeg'])) {
                ...
                $filePath = $file->move(public_path('uploads/passport'), $fileName);
                $path = asset('uploads/passport/' . $fileName);
                
                $api_key = env('NANO_API',null);
                $modelId = '4fb736b2-87e9-4520-af6a-83db42991bc1'; //Passport
                ...
                return view('model.passport', ['path' => $path, 'data' => $data]);
