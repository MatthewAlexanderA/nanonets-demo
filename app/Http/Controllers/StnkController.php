    ...
    public function extract(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($extension === 'pdf' || in_array($extension, ['png', 'jpg', 'jpeg'])) {
                ...
                $filePath = $file->move(public_path('uploads/stnk'), $fileName);
                $path = asset('uploads/stnk/' . $fileName);
                
                $api_key = env('NANO_API',null);
                $modelId = 'ef900770-4b11-4570-9bcb-d52270476c34'; //Stnk
                ...
                return view('model.stnk', ['path' => $path, 'data' => $data]);
