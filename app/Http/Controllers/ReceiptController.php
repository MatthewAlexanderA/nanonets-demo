    ...
    public function extract(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($extension === 'pdf' || in_array($extension, ['png', 'jpg', 'jpeg'])) {
                ...
                $filePath = $file->move(public_path('uploads/receipt'), $fileName);
                $path = asset('uploads/receipt/' . $fileName);
                
                $api_key = env('NANO_API',null);
                $modelId = '3b90dd54-4c9c-41ce-9ba0-ffcb8560bf9d'; //Receipt
                ...
                return view('model.receipt', ['path' => $path, 'data' => $data]);
