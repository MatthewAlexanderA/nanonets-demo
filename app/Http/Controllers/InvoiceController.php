    ...
    public function extract(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($extension === 'pdf' || in_array($extension, ['png', 'jpg', 'jpeg'])) {
                ...
                $filePath = $file->move(public_path('uploads/invoices'), $fileName);
                $path = asset('uploads/invoices/' . $fileName);
                
                $api_key = env('NANO_API',null);
                $modelId = '797a7dd9-8d19-404a-897c-cddb1e804633'; //Invoice
                ...
                return view('model.invoice', ['path' => $path, 'data' => $data]);
