...
<section id="Main">
    <h1 class="text-2xl text-blue lg:pt-6 pt-5 lg:pb-6 pb-5 font-bold px-6">Nanonets <span
            class="text-black">Kartu Keluarga</span></h1>
    <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-x-12 lg:px-10 px-5">
        <div class="">
            <form action="{{ route('extractKartuKeluarga') }}" method="post" enctype="multipart/form-data" id="extract">
                @csrf
                <label for="file-input" id="dropArea">
                    <div class="border-2 border-dashed border-gray-400 rounded-md">
                        @if (!empty($path))
                            <div dir="rtl">
                                <a href="/kartu-keluarga" class="rounded-full bg-red-500 hover:bg-red-700 text-white py-4 px-5 absolute mr-4 mt-4">
                        ...
                        @else
                            <div dir="rtl">
                                <a href="/kartu-keluarga" id="delete-btn" class="hidden rounded-full bg-red-500 hover:bg-red-700 text-white py-4 px-5 absolute mr-4 mt-4">
                                    <i class="fa-solid fa-trash"></i>
                                </a>
                            </div>
